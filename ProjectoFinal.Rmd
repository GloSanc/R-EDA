---
title: "White Wine: The Quality Of The Taste"
...
counts <- table(WWQ$quality)
barplot(counts, main="~3600 white wine are good wines",
  xlab='Wine rating', col=c("lightgoldenrod", "lightgoldenrod", "lightgoldenrod1", "lightgoldenrod1", "lightgoldenrod1","lightgoldenrod3", "lightgoldenrod3"),
...
head((table(WWQ$citric.acid,  dnn = "Count for citric acid (g / dm^3) low values")))
```
...
rs1=qplot(x =  residual.sugar,  data = WWQ, binwidth = 0.1, color=I("brown"),
      xlab= 'residual sugar (g / dm^3)',
      ylab= 'Count') + 
 scale_x_continuous (breaks = seq(0, 66, 5))

# Histogram residual.sugar1
rs3=qplot(x =  residual.sugar,  data = WWQ, binwidth = 0.1, color=I("white"),
      xlab= 'residual sugar (g / dm^3)',
      ylab= 'Count') + 
 scale_x_log10 (breaks = seq(0, 66, 1))

# Histogram residual.sugar1
rs2=qplot(x =  residual.sugar,  data = WWQ, binwidth = 0.1, color=I("white"),
      xlab= 'residual sugar (g / dm^3)',
      ylab= 'Count') + 
...
```{r echo=FALSE, warning=FALSE, fig.width=9, fig.height=16}

# Histogram chlorides (sodium chloride - g / dm^3)
c1=qplot(x =  chlorides,  data = WWQ, binwidth = 0.005, color=I("white"),
      xlab= 'chlorides (sodium chloride - g / dm^3)',
      ylab= 'Count') + 
 scale_x_continuous (breaks = seq(0, 0.35, 0.025))

c2=qplot(x =  chlorides,  data = WWQ, binwidth = 0.001, color=I("white"),
      xlab= 'chlorides (sodium chloride - g / dm^3)',
      ylab= 'Count') + 
...
sd3=qplot(x =  free.sulfur.dioxide,  data = WWQ, binwidth = 5, color=I("white"),
      xlab= 'Free Sulfur Dioxide (mg / dm^3)',
      ylab= 'Count') +
  scale_x_continuous (breaks = seq(0, 300, 20))

# Histogram total.sulfur.dioxide
sd4=qplot(x =  total.sulfur.dioxide,  data = WWQ, binwidth = 5,color=I("white"), 
...
grid.arrange(c1, c2, sd3,sd4, ncol=1)
```
...
# Histogram pH
qplot(x =  pH,  data = WWQ, binwidth = 0.05, color=I("lightpink"),
      xlab= 'pH',
      ylab= 'Count') + 
 scale_x_continuous (limits = c(2.5, 4),breaks = seq(2.5, 4, 0.1))

qplot(x =  sulphates,  data = WWQ, binwidth = 0.01, color=I("lightpink"),
...
#total sulfur dioxide (mg / dm^3)w/o outliers
...
boxplot(chlorides ~ quality, data=eliminated_ch,
        xlab="Quality", ylab="chlorides (sodium chloride - g / dm^3")

boxplot(volatile.acidity  ~ quality, data=eliminated_va,
        xlab="Quality", ylab="volatile acidity (acetic acid - g / dm^3)")
...
mv1=ggplot(WWQ, aes(x = alcohol, y = density , color = quality.cut)) +
  ...
  theme(legend.background = element_rect(fill="lightblue",
                                  ...
                                  colour ="darkblue"))+
  ggtitle("alcohol (% by volume) vs Denstiy") +
  xlab("alcohol (% by volume)") +
  ylab("density (g / cm^3)")
...
grid.arrange(mv1, mv2, ncol=1)

```


```{r echo=FALSE, message=FALSE, warning=FALSE,  fig.width=9, fig.height=16}
# with code suggest by the revison in Udacity

mv21=ggplot(WWQ, aes(x = alcohol, y = density , color = factor(quality))) +
   coord_cartesian(
      xlim = c(quantile(WWQ$alcohol, .01), quantile(WWQ$alcohol, .99)),
      ylim = c(quantile(WWQ$density, .01), quantile(WWQ$density, .99))) +
  geom_jitter(alpha =15, size = 1.5) +
...
# create a subset based on quality
WWQ_qmax = subset(WWQ,quality>=5 & quality<9)

# use the subset in:
mv22=ggplot(WWQ_qmax, aes(x = alcohol, y = density 
                )) +
  coord_cartesian(
      xlim = c(quantile(WWQ$alcohol, .01), quantile(WWQ$alcohol, .99)),
      ylim = c(quantile(WWQ$density, .01), quantile(WWQ$density, .99))
  ...
  geom_jitter(alpha = 10, size = 1.5) +
  geom_point(aes(colour = factor(quality)), size = 4)+ 
  geom_smooth(method = "lm", se = FALSE) +
  theme(legend.position = c(0.9, 0.7))+
  theme(legend.background = element_rect(fill="grey",
                                  size=0.5, linetype="solid", 
...
grid.arrange(mv21, mv22, ncol=1)

```

Those 4 chart represent the same information but none of them are really clear, 
they are good examples of what important the colors, shape and size of the chart
elements are basic


```{r echo=FALSE, message=FALSE, warning=FALSE,  fig.width=9, fig.height=10 }
ch1=qplot(x = alcohol, y = density, data = WWQ, color = quality, alpha = I(1/5)) + 
    coord_cartesian(ylim = c(0.985, 1.005)) + facet_wrap(~quality)+
    scale_color_gradientn(colours = rainbow(9))+ 
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('alcohol (% by volume) and density (g / cm^3) per quality')

#code suggested by Udacity corrector

ch2=qplot(x = alcohol, y = density, data = WWQ, color = factor(quality), alpha = I(0.9)) + 
    coord_cartesian(ylim = c(0.985, 1.005)) + facet_wrap(~quality)+
...
#mv1=
  ggplot(WWQ, aes(x = residual.sugar, y = density , color = quality.cut)) +
  coord_cartesian(
  ...
  theme_dark() +
  ggtitle("residual sugar (g / dm^3) vs Denstiy") +
  xlab("residual.sugar") +
  ylab("density (g / cm^3)")
...
qplot(x = residual.sugar, y = density, data = WWQ, color = quality, alpha = I(1/5)) + 
    ...
    scale_color_gradientn(colours = rainbow(9)) + 
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('residual sugar (g / dm^3) and Denstiy per quality')
```
...
qplot(x = alcohol, y = chlorides, data = WWQ, color = quality, alpha = I(1/5)) +
    ...
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('alcohol (% by volume) and chlorides (sodium chloride - g / dm^3 per quality')
```
...
#mts1=
  ggplot(WWQ, aes(x = alcohol, y = total.sulfur.dioxide , color = quality.cut)) +
  coord_cartesian(
      xlim = c(quantile(WWQ$alcohol, .01), quantile(WWQ$alcohol, .99)),
  ...
  theme(legend.background = element_rect(fill="lightblue",
                                  size=0.5, linetype="solid", 
                                  colour ="darkblue"))+
  ggtitle("alcohol (% by volume) vs total.sulfur.dioxide") +
  xlab("alcohol (% by volume)") +
...
qplot(x = alcohol, y = total.sulfur.dioxide, data = WWQ, color = quality, alpha = I(1/5)) + 
    ...
    scale_color_gradientn(colours = rainbow(5))+ 
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('alcohol (% by volume) and Total sulfur dioxides per quality')
```
...
qplot(x = alcohol, y = residual.sugar, data = WWQ, color = quality, alpha = I(1/5)) + 
    ...
    scale_color_gradientn(colours = rainbow(5))+ 
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('alcohol (% by volume) and residual sugar (g / dm^3) per quality')
```
...
qplot(x = residual.sugar, y = chlorides, data = WWQ, color = quality, alpha = I(1/5)) +
    ...
    scale_color_gradientn(colours = rainbow(5))+ 
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('residual sugar (g / dm^3) and chlorides (sodium chloride - g / dm^3 per quality')
```
...
#mts1=
  ggplot(WWQ, aes(x = chlorides, y = total.sulfur.dioxide , color = quality.cut)) +
  coord_cartesian(
  ...
  theme(legend.background = element_rect(fill="lightblue",
                                  size=0.5, linetype="solid", 
                                  colour ="darkblue"))+
  ggtitle("chlorides (sodium chloride - g / dm^3 vs total.sulfur.dioxide") +
  xlab("chlorides (sodium chloride - g / dm^3") +
  ylab("total.sulfur.dioxide")
...
qplot(x = chlorides, y = total.sulfur.dioxide, data = WWQ, color = quality, alpha = I(1/20)) + 
    ...
    geom_smooth(method = "lm", se = FALSE) +
    ggtitle('chlorides (sodium chloride - g / dm^3 and Total sulfur dioxides per quality')
...
#mts1=
  ggplot(eliminated_cl_ts, aes(x = chlorides, y = total.sulfur.dioxide , color = quality.cut2)) +
...
```{r echo=FALSE, message=FALSE, warning=FALSE,  fig.width=9, fig.height=9, Plot_Two}

quality.cut <- cut(WWQ$quality, breaks = c(2,3,4,5,6,7,8,9,10))

fp21=ggplot(WWQ, aes(x = alcohol, y = density , color = quality.cut, size=residual.sugar)) +
  coord_cartesian(
  ...
  theme(legend.background = element_rect(fill="lightblue",
                                  size=0.5, linetype="solid", 
                                  colour ="darkblue"))+
  ggtitle("alcohol (% by volume) vs Denstiy interquantile (25% - 75%)") +
  xlab("alcohol (% by volume)") +
  ylab("density (g / cm^3)")

#with Udacity corrections

fp22=ggplot(WWQ, aes(x = alcohol, y = density , color = factor(quality), size=residual.sugar)) +
  coord_cartesian(
      xlim = c(quantile(WWQ$alcohol, .25), quantile(WWQ$alcohol, .75)),
      ylim = c(quantile(WWQ$density, .25), quantile(WWQ$density, .75))) +
  geom_jitter(width=0.015,height=0,alpha =1, size = 1.5) +
  geom_smooth(method = "lm", se = FALSE) +
  scale_color_brewer(type = "div", palette = "RdYlBu",
                     name = "Quality", direction = -1) +
  theme_dark() +
...
If we make a focus on the chart to see the interquantile space, the distribution 
of those characteristic in the different quality categories do not show 
big differences, the lines representing the linear regression for each category
are very close and nearly parallel
...
p31=ggplot(WWQ, aes(x = chlorides, y = total.sulfur.dioxide , color = factor(quality), size=residual.sugar)) +
  geom_jitter(width=0.015,height=0,alpha =1, size = 1.5) +
  geom_smooth(method = "lm", se = FALSE) +
  scale_color_brewer(type = "div", palette = "RdYlBu",
                     name = "Quality", direction = -1) +
...
p32=ggplot(eliminated_cl_ts, aes(x = chlorides, y = total.sulfur.dioxide , color = factor(quality), size=residual.sugar)) +
  geom_jitter(width=0.015,height=0,alpha =1, size = 0.5) +
  geom_smooth(method = "lm", se = FALSE) +
  scale_color_brewer(type = "div", palette = "RdYlBu",
                     name = "Quality", direction = -1) +
  theme_dark() +
  theme(legend.background = element_rect(fill="lightblue",
                                  size=0.5, linetype="solid", 
                                  colour ="darkblue"))+
  ggtitle("Chlorides vs total sulfur dioxide (mg / dm^3)interquantile") +
  xlab("Chlorides") +
  ylab("total.sulfur.dioxide")
...
One possible future analyse could be done taking a sample of wines from different
quality score but similar values on the chemical characteristic and make a details
analysis of the variations between them that makes it to be in an score and not
in the other

Another possible analysis could be done taking the 3 originals score of each wine
and generate a data set of 3 times the size of this data set but keeping the
information related to each wine, it means we can see the 3 score of each wine
and trate the information as different wine. That could help to find the key for 
a wine that can be score 5 for one and 7 for another, for example
